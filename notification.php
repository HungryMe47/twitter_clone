...
<head>
    ...
    <title>Notifications | Yarn</title>
    ...
    <div class="wrapper-left">
        <div class="sidebar-left">
          <div class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="https://i.imgur.com/b9Qj9Pe.png" alt="" height="30px" width="40px" />
            </div>
          </div>
          ...
          <a href="home.php">
            <div class="grid-sidebar bg-active" style="margin-top: 12px">
              <div class="icon-sidebar-align">
                <img src="https://images.rawpixel.com/image_png_800/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIyLTA1L3JtNTMzLW91dGxpbmUtMTZfMS5wbmc.png" alt="" height="26.25px" width="26.25px" style="filter: invert(100%);" />
              </div>
          ...
          <div class="grid-sidebar">
            <div class="icon-sidebar-align position-relative">
              ...
              <?php } ?>
              <img
                src="https://p7.hiclipart.com/preview/845/182/351/computer-icons-download-clip-art-notification-icon.jpg" alt="" height="22px" width="22px" style="filter: invert(100%); opacity: 0.8;"/>
            </div>
          ...
          <div class="grid-sidebar">
            <div class="icon-sidebar-align">
              <img src="https://static.vecteezy.com/system/resources/thumbnails/002/318/271/small/user-profile-icon-free-vector.jpg" alt="" height="29px" width="29px" style="filter: invert(100%);"/>
            </div>
          ...
          <div class="grid-sidebar ">
            <div class="icon-sidebar-align">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTnRURgiWstLv1FvCfzivDMccFJkEvTUJsMxsrh-w6F9Q&s" alt="" height="26.25px" width="26.25px" style="filter: invert(100%); opacity: 0.6;"/>
            </div>
      ...
      <div class="grid-posts">
        ...
        <div class="wrapper-right">
            ...
            <input type="text" class="form-control search-input"  placeholder="Search Yarn">
