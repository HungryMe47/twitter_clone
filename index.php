            ...
            <section class="twt-login">
                <?php include 'includes/login.php';  ?>
                    <div class="slow-login">
                        <img class="login-bird" src="https://i.imgur.com/b9Qj9Pe.png" alt="bird">
                        <button class="login-small-display signin-btn pri-btn">Log in</button>
                        <div>
                          <span style="font-family: 'Ubuntu', sans-serif; font-size: 40; font-weight: 500; font-style: normal;">Yarn</span><br>
                        </div>
                        <span class="front-para">A safe space for you</span>
                        <span class="join">Join today.</span>
